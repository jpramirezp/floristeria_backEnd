...
class EmpleadosController {
    ...
    getEmpleados(req, res) {
        ...
        let pNom_Emp = 'pNom_Emp';
        let pApe_Emp = 'pApe_Emp';
        let pNoID_Emp = 'pNoID_Emp';
        let pTel_Emp = 'pTel_Emp';
        let pCargo_Emp = 'pCargo_Emp';
        let pArea_Emp = 'pArea_Emp';
        let pDir_Emp = 'pDir_Emp';
        let pEstado_Emp = 'pEstado_Emp';
